...
- Negative: `https://docs.python.org/3/library/json.html` → no match
...
### Fixture Skills
- `tests/fixtures/safe-skill/` — clean skill, should produce zero findings
- `tests/fixtures/risky-skill/` — one example of every threat, should flag all
- `tests/fixtures/ambiguous-skill/` — edge cases, context-dependent patterns
